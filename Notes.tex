...
%% 置换(Permutation)
\newcommand{\Perm}[1]{\symbf{#1}}

%% 恒等映照(Identity)
\newcommand{\Id}{\mathbfsfup{Id}}
%% Kronecker Delta
...
\newcommand{\fdp}{\odot}
%% 叉乘(has been defined in physics package)
...
\newcommand{\Tensors}[2][\Rm]{\symcal{J}^{#2}\qty(#1)}
%% r 阶置换全体
\newcommand{\Permutations}[1]{P_{#1}}
