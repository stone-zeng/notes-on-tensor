...
%	\pagestyle{fancy} % draft 下禁用
	\pagestyle{plain}
	\ctexset{
		section/format+ = {\normalfont\sffamily\CJKfamily{黑体}},
		subsection/format+ = {\normalfont\sffamily\CJKfamily{黑体}},
		% 目录名称
...
\usepackage{xeCJK}
	...
	\setCJKsansfont{方正黑体_GBK}[
		BoldFont = 方正黑体_GBK, ItalicFont = 方正黑体_GBK,
		Mapping = fullwidth-stop
	]
	\setCJKmonofont{方正仿宋_GBK}[
		BoldFont = 方正仿宋_GBK, ItalicFont = 方正楷体_GBK,
		Mapping = fullwidth-stop
	]
...
%		
%		\chapter{非完整基理论}
%			\input{Chapters/Nonholonomic_Basis_Theory}
%		
